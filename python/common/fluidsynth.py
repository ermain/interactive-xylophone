...
Addintional Modifications, Copyright 2015, Eran Egozy (eran@egozy.org)
...
fluid_synth_get_rev_roomsize = cfunc('fluid_synth_get_reverb_roomsize', c_double,
                                    ('synth', c_void_p, 1))

fluid_synth_get_rev_damp = cfunc('fluid_synth_get_reverb_damp', c_double,
                                    ('synth', c_void_p, 1))

fluid_synth_get_rev_level = cfunc('fluid_synth_get_reverb_level', c_double,
                                    ('synth', c_void_p, 1))

fluid_synth_get_rev_width = cfunc('fluid_synth_get_reverb_width', c_double,
                                    ('synth', c_void_p, 1))

fluid_synth_set_reverb = cfunc('fluid_synth_set_reverb', c_void_p,
                             ('synth', c_void_p, 1),
                             ('roomsize', c_double, 1),
                             ('damping', c_double, 1),
                             ('width', c_double, 1),
...
class Synth(object):
    ...
    def get_reverb_params(self) :
        ...
        return (fluid_synth_get_rev_roomsize(self.synth),
                fluid_synth_get_rev_damp(self.synth),
                fluid_synth_get_rev_width(self.synth),
                fluid_synth_get_rev_level(self.synth))
    ...
    def set_reverb_on(self, on) :
        ...
        return fluid_synth_set_reverb_on(self.synth, on)
